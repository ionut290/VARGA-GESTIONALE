...
const VG_BUILD='20260903-2205-accounting-rounds1';
['app-core.js','app-business.js','app-varga.js','app-sync.js','app-cloud.js','accounting-sheet-view.js','accounting-round-history.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
