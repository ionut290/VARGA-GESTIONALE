...
const VG_BUILD='20260904-quote-xlsx-selfcontained-v13';
window.VG_BUILD=VG_BUILD;
['app-core.js','app-business.js','clienti-avola.js','assets/avola-sidebar-1.js','assets/avola-sidebar-2.js','assets/avola-sidebar-3.js','assets/avola-sign-1.js','assets/avola-sign-2.js','assets/avola-image-loader.js','preventivi-avola.js','app-varga.js','app-sync.js','app-cloud.js','cloud-incremental-sync.js','accounting-sheet-view.js','accounting-sheet-tools.js','accounting-client-export-form.js','accounting-round-history-v2.js','dashboard-accounting-rounds.js','round-dashboard-settings.js','map-mail-bridge.js','workforce-history.js','rapportini-lavoro.js','prezzari-excel-view.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
