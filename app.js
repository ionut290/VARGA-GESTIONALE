...
const VG_BUILD='20260903-2035-accounting-linked1';
['app-core.js','app-business.js','app-varga.js','app-sync.js','app-cloud.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
