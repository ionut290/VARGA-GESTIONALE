...
const VG_BUILD='20260903-2148-map-senders-per-job1';
['app-core.js','app-business.js','app-varga.js','app-sync.js','app-cloud.js','accounting-sheet-view.js','accounting-round-history-v2.js','dashboard-accounting-rounds.js','round-dashboard-settings.js','map-senders-per-job.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
