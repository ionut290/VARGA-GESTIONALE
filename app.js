...
const VG_BUILD='20260904-0508-workforce-history2';
['app-core.js','app-business.js','app-varga.js','app-sync.js','app-cloud.js','cloud-incremental-sync.js','accounting-sheet-view.js','accounting-round-history-v2.js','dashboard-accounting-rounds.js','round-dashboard-settings.js','map-mail-bridge.js','workforce-history.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
