...
const VG_BUILD='20260903-2135-accounting-client-export1';
['app-core.js','app-business.js','app-varga.js','app-sync.js','app-cloud.js','accounting-sheet-view.js'].forEach(function(src){document.write('<script src="'+src+'?v='+VG_BUILD+'"></scr'+'ipt>');});
