...
(function(){
  const SECTION_KEYS=['priceLists','clients','quotes','jobs','invoices','expenses','economicEntries','deadlines','documents','consuntivi','depurazioneConsuntivi','discaricheConsuntivi','requests','company'];
