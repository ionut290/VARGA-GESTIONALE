...
(function(){
  const SECTION_KEYS=['priceLists','clients','quotes','jobs','invoices','expenses','deadlines','documents','consuntivi','depurazioneConsuntivi','discaricheConsuntivi','requests','company'];
