...
2. Dopo aver creato i segreti, unire la PR Firebase: il workflow include già `functions:callVargaBridgeVault` nella lista di deploy. Il service account Firebase Functions deve poter leggere entrambi i segreti. Poi unire la PR del Gestionale.
