(() => {
  ...
  const DATASETS = Object.freeze([
    ...
    { id: "alberi-manutenzioni", icon: "🌲", title: "Catasto alberi", short: "Catasto degli alberi con numero punto, specie, caratteristiche e coordinate.", titleFields: ["specie", "specie_nome", "nome", "numpt"], codeFields: ["numpt", "id", "codice"], searchHint: "numero punto, specie, via o quartiere" },
